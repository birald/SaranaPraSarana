...
<html class="boxed">
	<head>
		...
		<title>Sarana | Dinas Pendidikan | Admin Sekolah</title>
					...
					<div id="userbox" class="userbox">
										...
										<div class="content">
								            ...
								            @foreach($top_notifikasis as $notifikasi)
								              @if($notifikasi->deskripsi == 'terima')
												<li>
													<a href="{{ url('sekolah/show_notifikasi/'.$notifikasi->id.'/'.$notifikasi->proposal_id)}}" class="clearfix">
														<div class="image">
															<i class="fa fa-bell bg-danger"></i>
														</div>
														<span class="title">Proposal di terima</span>
								              ...
								              @elseif($notifikasi->deskripsi == 'tolak')
												<li>
													<a href="{{ url('sekolah/show_notifikasi/'.$notifikasi->id.'/'.$notifikasi->proposal_id)}}" class="clearfix">
														...
														<span class="title">Proposal di tolak</span>
														<span class="message">{{$notifikasi->created_at}}</span>
													</a>
												</li>
								              @elseif($notifikasi->deskripsi == 'kirim_dana')
												<li>
													<a href="{{ url('sekolah/show_notifikasi/'.$notifikasi->id.'/'.$notifikasi->proposal_id)}}" class="clearfix">
														...
														<span class="title">Pengiriman dana proposal</span>
														<span class="message">{{$notifikasi->created_at}}</span>
													</a>
												</li>
												...
												<li>
													<a href="{{ url('sekolah/show_notifikasi/'.$notifikasi->id.'/'.$notifikasi->proposal_id)}}" class="clearfix">
														...
														<span class="title">Proposal selesai</span>
														<span class="message">{{$notifikasi->created_at}}</span>
													</a>
												</li>
												@endif
											...
											<div class="text-right">
												<a href="{{url('sekolah/all_notifikasi')}}" class="view-more">View All</a>
											</div>
										</div>
									</div>
									@else
						...
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="johndoe@okler.com">
								<span class="name">{{auth()->guard('sekolah')->user()->nama}}</span>
								<span class="role">Administrator Sekolah</span>
							</div>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="{{ url('logout_sekolah')}}"><i class="fa fa-power-off"></i> Logout</a>
								</li>
							</ul>
						</div>
					</div>
								...
								<ul class="nav nav-main">
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="{{ url('/sekolah/daftar_terima')}}">
												<i class="fa fa-circle-o-notch" aria-hidden="true"></i>
													 Daftar Proposal di Terima
												</a>
											</li>
											<li>
												<a href="{{ url('/sekolah/tambah_proposal_sekolah')}}">
												<i class="fa fa-circle-o-notch" aria-hidden="true"></i>
													 Buat Proposal
												</a>
											</li>
									...
									<li>
										<a href="{{ url('/sekolah/all_notifikasi')}}">
											<i class="fa fa-bell" aria-hidden="true"></i>
											<span>Notifikasi</span>
										</a>
									</li>
									<li>
										<a href="{{ url('logout_sekolah')}}">
