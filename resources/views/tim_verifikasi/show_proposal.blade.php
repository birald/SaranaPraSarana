...
@section('content')
	...
	<section class="panel">
        ...
        @if($sisa_hari != "habis")
        <button style="width: 100%" onclick="valid('{{$proposals->id}}','{{$proposals->tingkat_sekolah}}')" class="btn btn-success">Verifikasi</button>
        {{-- <button style="width: 49%" onclick="unvalid('{{$proposals->id}}','{{$proposals->tingkat_sekolah}}')" class="btn btn-danger">Tidak valid</button> --}}
        @endif
			...
			<div class="row">
				...
				<div class="col-md-4 col-lg-4 col-xl-3">
					...
					<section class="panel panel-featured-left panel-featured-warning bg-warning">
						<div class="panel-body bg-warning">
							<div class="widget-summary widget-summary-sm bg-warning">
								<div class="widget-summary-col widget-summary-col-icon">
								...
								<div class="widget-summary-col">
				                        ...
				                        @if($sisa_hari == "habis")
											<div class="summary">
												<h1 class="title"><b>Batas verifikasi<br> Habis</b></h1>
											</div>
										@else
											<div>
												<h1 class="title"><b>H-{{$sisa_hari}} Hari</b></h1>
											</div>
										@endif
								</div>
							</div>
